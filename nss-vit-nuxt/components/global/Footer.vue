...
const quickLinks = [
  ...
  { path: '/developers', name: 'Meet the Devs' },
];
</script>

<template>
  <footer class="bg-blue-800 py-8 mt-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <!-- About -->
        <div>
          <h3 class="text-lg font-semibold text-background mb-4">About</h3>
        ...
        <!-- Quick Links -->
        <div>
          <h3 class="text-lg font-semibold text-background mb-4">Quick Links</h3>
          <ul>
            <li v-for="link in quickLinks" :key="link.path">
              <NuxtLink
                :to="link.path"
                class="text-sm transition-all duration-300 ease-in-out text-blue-200 hover:text-secondary hover:scale-105"
        ...
        <!-- Contact -->
        <div>
          <h3 class="text-lg font-semibold text-background mb-4">Contact</h3>
          <p class="text-blue-200 text-sm flex items-center gap-2">
            ...
            <a href="mailto:nss@vit.edu.in" class="hover:text-secondary transition">
              nss@vit.edu.in
            </a>
          </p>
          <a
            ...
            class="text-blue-200 text-sm flex items-center gap-2 hover:text-secondary transition mt-2"
          >
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#B7B7B7" class="flex-shrink-0">
        ...
        <!-- Social Links -->
        <div>
          <h3 class="text-lg font-semibold text-background mb-4">Follow Us</h3>
          <div class="flex space-x-4">
            <a
              href="https://www.instagram.com/nss_vit/" target="_blank" rel="noopener noreferrer"
              class="text-blue-200 hover:text-pink-500 transition"
              aria-label="Instagram"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" width="32" height="32" viewBox="0 0 32 32">
            ...
            <a
              href="https://www.youtube.com/@nss-vitvidyalankarinstitut5393/videos" target="_blank" rel="noopener noreferrer"
              class="text-blue-200 hover:text-red-600 transition"
              aria-label="YouTube"
            >
            ...
            <a
              href="https://www.facebook.com/people/NSS-VIT/100064835765369/" target="_blank" rel="noopener noreferrer"
              class="text-blue-200 hover:text-secondary transition"
              aria-label="Facebook"
            >
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Copyright -->
      <div id="contact" class="mt-8 border-t border-blue-700 pt-4 text-center">
